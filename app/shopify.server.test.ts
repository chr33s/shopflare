...
test("admin", () => {
  expect(shopify.admin).toBeTypeOf("function");
});
...
test("proxy", () => {
  expect(shopify.proxy).toBeTypeOf("function");
});
...
describe("utils", () => {
  ...
  test("legacyUrlToShopAdminUrl", () => {
    ...
    expect(shopify.utils.legacyUrlToShopAdminUrl("test.example.com")).toBe(null);
  });
  ...
  test("sanitizeShop", () => {
    ...
    expect(shopify.utils.sanitizeShop("admin.shopify.com/store/test")).toBe(shop);
...
test("webhook", () => {
  expect(shopify.webhook).toBeTypeOf("function");
});
