...
type MetafieldNodesFragment_P0QbxsDvoI0bGQdfOyaK9cAg67CJcsmqfjzzTcAjA_Fragment = {
  metafields: { nodes: Array<Pick<AdminTypes.Metafield, "id" | "key" | "namespace" | "value">> };
};
...
export type BulkOperationRunQueryMutation = {
  bulkOperationRunQuery?: AdminTypes.Maybe<{
    bulkOperation?: AdminTypes.Maybe<
      ...
      >
    >;
    userErrors: Array<Pick<AdminTypes.BulkOperationUserError, "field" | "message">>;
  }>;
};
...
export type MetafieldDefinitionCreateMutation = {
  metafieldDefinitionCreate?: AdminTypes.Maybe<{
    createdDefinition?: AdminTypes.Maybe<Pick<AdminTypes.MetafieldDefinition, "id" | "name">>;
    userErrors: Array<
      Pick<AdminTypes.MetafieldDefinitionCreateUserError, "code" | "field" | "message">
    >;
  }>;
};
...
export type MetafieldDefinitionDeleteMutation = {
  metafieldDefinitionDelete?: AdminTypes.Maybe<
    Pick<AdminTypes.MetafieldDefinitionDeletePayload, "deletedDefinitionId"> & {
      userErrors: Array<
        Pick<AdminTypes.MetafieldDefinitionDeleteUserError, "code" | "field" | "message">
      >;
    }
  >;
};
...
export type MetafieldDefinitionUpdateMutation = {
  metafieldDefinitionUpdate?: AdminTypes.Maybe<{
    updatedDefinition?: AdminTypes.Maybe<Pick<AdminTypes.MetafieldDefinition, "id" | "name">>;
    userErrors: Array<
      Pick<AdminTypes.MetafieldDefinitionUpdateUserError, "code" | "field" | "message">
    >;
  }>;
};
...
export type MetafieldDeleteMutation = {
  metafieldsDelete?: AdminTypes.Maybe<{
    deletedMetafields?: AdminTypes.Maybe<
      Array<AdminTypes.Maybe<Pick<AdminTypes.MetafieldIdentifier, "key" | "namespace" | "ownerId">>>
    >;
    userErrors: Array<Pick<AdminTypes.UserError, "field" | "message">>;
  }>;
};
...
export type MetafieldsSetMutation = {
  metafieldsSet?: AdminTypes.Maybe<{
    metafields?: AdminTypes.Maybe<
      Array<Pick<AdminTypes.Metafield, "key" | "namespace" | "value" | "createdAt" | "updatedAt">>
    >;
    userErrors: Array<Pick<AdminTypes.MetafieldsSetUserError, "code" | "field" | "message">>;
  }>;
};
...
export type BillingCheckQuery = {
  currentAppInstallation: {
    activeSubscriptions: Array<Pick<AdminTypes.AppSubscription, "id" | "name" | "test" | "status">>;
    oneTimePurchases: {
      nodes: Array<Pick<AdminTypes.AppPurchaseOneTime, "id" | "name" | "test" | "status">>;
...
export type CurrentBulkOperationQuery = {
  currentBulkOperation?: AdminTypes.Maybe<
    Pick<AdminTypes.BulkOperation, "errorCode" | "id" | "type" | "status" | "url">
  >;
};
...
export type FileQuery = {
  node?: AdminTypes.Maybe<
    | ({ __typename: "GenericFile" } & Pick<AdminTypes.GenericFile, "fileStatus" | "id" | "url"> & {
          fileErrors: Array<Pick<AdminTypes.FileError, "code" | "details" | "message">>;
        })
    | ({ __typename: "MediaImage" } & Pick<AdminTypes.MediaImage, "fileStatus" | "id"> & {
          fileErrors: Array<Pick<AdminTypes.FileError, "code" | "details" | "message">>;
          image?: AdminTypes.Maybe<Pick<AdminTypes.Image, "url">>;
        })
    | ({ __typename: "Model3d" } & Pick<AdminTypes.Model3d, "fileStatus" | "id"> & {
          fileErrors: Array<Pick<AdminTypes.FileError, "code" | "details" | "message">>;
...
export type MetafieldDefinitionQuery = {
  metafieldDefinition?: AdminTypes.Maybe<Pick<AdminTypes.MetafieldDefinition, "id">>;
};
...
export type MetafieldsQueryVariables = AdminTypes.Exact<{
  ...
  keys?: AdminTypes.InputMaybe<
    Array<AdminTypes.Scalars["String"]["input"]> | AdminTypes.Scalars["String"]["input"]
  >;
  namespace?: AdminTypes.InputMaybe<AdminTypes.Scalars["String"]["input"]>;
  ownerId: AdminTypes.Scalars["ID"]["input"];
}>;
...
export type MetaobjectDefinitionQuery = {
  metaobjectDefinition?: AdminTypes.Maybe<Pick<AdminTypes.MetaobjectDefinition, "id">>;
};
