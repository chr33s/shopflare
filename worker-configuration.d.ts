/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=./wrangler.rsc.json --config=./wrangler.json` (hash: ea6393ab9c166e9a3d6cab79db65cc7e)
// Runtime types generated with workerd@1.20250803.0 2025-06-17 nodejs_als
declare namespace Cloudflare {
	interface Env {
		...
		SHOPIFY_DURABLE_OBJECT: DurableObjectNamespace<
			import('./app/server.ts').ShopifyDurableObject
		>;
