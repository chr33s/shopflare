/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=./wrangler.json --config=./wrangler.rsc.json` (hash: 87bda700e32c58979555514347e298c1)
// Runtime types generated with workerd@1.20250712.0 2025-06-17 nodejs_als
declare namespace Cloudflare {
	interface Env {
		SESSION_KV: KVNamespace;
		NODE_VERSION: 22;
		SHOPIFY_API_KEY: '17b048405a3e2ffe901be65f5783837d';
		SHOPIFY_APP_HANDLE: 'shopflare';
		SHOPIFY_APP_URL: 'https://shopflare.chr33s.dev';
		SHOPIFY_API_SECRET_KEY: string;
		SHOPIFY_DURABLE_OBJECT: DurableObjectNamespace /* ShopifyDurableObject */;
		RSC: Fetcher /* shopflare-rsc */;
		WEBHOOK_QUEUE: Queue;
		ASSETS: Fetcher;
